...
/*app.use('/admin/comment/', adminRoute);*/
app.use('/admin/updateStatus/', adminRoute);
app.use('/getFirstPage', employeeRoute);
app.use('/nextPage', employeeRoute);
app.use('/employeeAdd/save/', employeeRoute);
app.use('/employeeModified/update/', employeeRoute);
app.use('/prevPage', employeeRoute);
app.use('/firstPage', employeeRoute);
app.use('/getTotalPage', employeeRoute);
app.use('/lastPage', employeeRoute);
app.use('/getTotalPageEmployee', employeeRoute);
